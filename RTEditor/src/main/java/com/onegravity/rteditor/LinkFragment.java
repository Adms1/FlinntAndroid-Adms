...
public class LinkFragment extends DialogFragment {
    ...
    private void validate(DialogInterface dialog, TextView addressView, TextView textView) {
        ...
        if (requiredFieldValid(addressView) && (isUrl || isEmail)) {
            ...
            //  Toast.makeText(getActivity(), "Enter valid link url", Toast.LENGTH_LONG).show();
            showAlertMessage();
    ...
    public void showAlertMessage() {
        ...
        titleText.setTextColor(Color.parseColor("#007DCD"));
        titleText.setTextSize(20);
        titleText.setTypeface(Typeface.DEFAULT_BOLD);
        alertDialogBuilder.setCustomTitle(titleText);

        // set dialog message
        alertDialogBuilder.setMessage("Enter valid link url");
        ...
        // show it
        alertDialog.show();
        alertDialog.getButton(AlertDialog.BUTTON_POSITIVE).setTextColor(Color.parseColor("#007DCD"));
    }
}