...
public class PostViewers {
    ...
    public PostViewers(Handler handler, String courseId, String postId, String postorcontent,int currentTab, int offSet) {
        mHandler = handler;
        mCourseID = courseId;
        mPostID = postId;
    ...
    public void sendPostViewersRequest(PostViewersRequest postListRequest) {
    ...
    private void sendJsonObjectRequest(String url, JSONObject jsonObject) {
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Method.POST, url,
            ...
            public void onResponse(JSONObject response) {
                if (LogWriter.isValidLevel(Log.DEBUG))
                    LogWriter.write("PostViewers Response :\n" + response.toString());
            ...
            public void onErrorResponse(VolleyError error) {
                if (LogWriter.isValidLevel(Log.ERROR))
                    LogWriter.write("PostViewers Error : " + error.getMessage());
