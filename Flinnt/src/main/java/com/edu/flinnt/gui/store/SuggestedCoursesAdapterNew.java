...
public class SuggestedCoursesAdapterNew<T> extends RecyclerView.Adapter<SuggestedCoursesAdapterNew.ViewHolder> {
    ...
    public SuggestedCoursesAdapterNew(ArrayList<T> myDataset, int type) {
    ...
    @Override
    public SuggestedCoursesAdapterNew.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                                    int viewType) {
        View v;
    ...
    @Override
    public void onBindViewHolder(final SuggestedCoursesAdapterNew.ViewHolder holder, int position) {
