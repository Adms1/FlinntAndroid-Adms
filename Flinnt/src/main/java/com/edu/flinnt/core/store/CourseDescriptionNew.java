 ...
 */
public class CourseDescriptionNew {

    public static final String TAG = CourseDescriptionNew.class.getSimpleName();
    ...
    public CourseDescriptionNew(Handler handler, String id) {
        mHandler = handler;
        courseId = id;
    ...
    public CourseDescriptionNew(Handler handler, String id, String hash) {
        mHandler = handler;
        courseId = id;
        inst_book_vendor_id = id;
        inst_book_set_vendor_id = id;
    ...
    public void sendRequest() {
        synchronized (CourseDescriptionNew.class) {
            try {
                ...
                if (LogWriter.isValidLevel(Log.DEBUG))
                    LogWriter.write("CourseDescriptionNew Request :\nUrl : " + url + "\nData : " + mCourseViewRequest.getJSONString());
    ...
    private void sendJsonObjectRequest(String url, JSONObject jsonObject) {
        ...
        CustomJsonObjectRequest jsonObjReq = new CustomJsonObjectRequest(Method.POST, url, jsonObject, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                if (LogWriter.isValidLevel(Log.DEBUG))
                    LogWriter.write("CourseDescriptionNew response :\n" + response.toString());
