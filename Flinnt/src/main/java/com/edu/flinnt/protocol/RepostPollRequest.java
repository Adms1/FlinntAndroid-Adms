 ...
 */
public class RepostPollRequest {
    ...
    @SerializedName("repost_course")
    @Expose
    private String repost_course;
    @SerializedName("resource_changed")
    @Expose
    private int resource_changed;
    ...
    public String getRepost_course() {
        return repost_course;
    }

    public void setRepost_course(String repost_course) {
        this.repost_course = repost_course;
    }
