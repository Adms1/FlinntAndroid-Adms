...
/**
 * Selectable rounded image widget class specially structured for showing images from internet
 */
public class SelectableRoundedCourseImageView extends NetworkImageView {

    public static final String TAG = "SelectableRoundedCourseImageView";
    ...
    public SelectableRoundedCourseImageView(Context context) {
        super(context);
    }

    public SelectableRoundedCourseImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SelectableRoundedCourseImageView(Context context, AttributeSet attrs, int defStyle) {
