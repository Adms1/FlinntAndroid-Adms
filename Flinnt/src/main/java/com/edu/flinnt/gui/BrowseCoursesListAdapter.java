 ...
 */
public class BrowseCoursesListAdapter<T> extends RecyclerView.Adapter<BrowseCoursesListAdapter.ViewHolder> {
    ...
    public BrowseCoursesListAdapter(Context context, List<T> myDataset,int type) {
    ...
    @Override
    public BrowseCoursesListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,int viewType) {
        View v;
    ...
    //08-01-2019 by vijay
    @Override
    public void onBindViewHolder(final BrowseCoursesListAdapter.ViewHolder holder, int position) {
                ...
                public void onClick(View v) {
                    ...
                    if(type == 1) {
                        ...
                        if (Helper.isConnected()) {
                            ...
                            courseDescriptionIntent.putExtra(BrowsableCourse.CART_COUNT,String.valueOf(BrowseCoursesFragment.cart_count));
