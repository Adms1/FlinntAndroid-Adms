 ...
 */
public class PostViewersComments {

    public static final String TAG = PostViewersComments.class.getSimpleName();
    ...
    public PostViewersComments(Handler handler, String courseId, String postId, String postorcontent, int currentTab, int offSet) {
        mHandler = handler;
        mCourseID = courseId;
        mPostID = postId;
    ...
    public void sendPostViewersCommentsRequest(PostViewersRequest postListRequest) {
        mPostViewersRequest = postListRequest;
        sendPostViewersCommentsRequest();
    }

    public void sendPostViewersCommentsRequest() {
        new Thread() {
            @Override
            public void run() {
                super.run();
    ...
    public void sendRequest() {
        synchronized (PostViewersComments.class) {
            try {
    ...
    private void sendJsonObjectRequest(String url, JSONObject jsonObject) {
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Method.POST, url,
            ...
            public void onResponse(JSONObject response) {
                if (LogWriter.isValidLevel(Log.DEBUG))
                    LogWriter.write("PostViewersComments Response :\n" + response.toString());
            ...
            public void onErrorResponse(VolleyError error) {
                if (LogWriter.isValidLevel(Log.ERROR))
                    LogWriter.write("PostViewersComments Error : " + error.getMessage());
