...
public class BottomSheet extends Dialog implements DialogInterface {
    ...
    BottomSheet(Context context, int theme) {
        ...
        TypedArray a = getContext()
                .obtainStyledAttributes(null, R.styleable.BottomSheet, R.attr.newBottomSheetStyle, 0);
        try {
    ...
    public static class Builder {
        ...
        public Builder(@NonNull Activity context) {
            ...
            TypedArray ta = context.getTheme().obtainStyledAttributes(new int[]{R.attr.newBottomSheetStyle});
            try {
