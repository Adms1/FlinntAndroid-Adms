 ...
 */
//@Chirag:08/09/2018 added : StoriesRecycleronScrollListener created by Chirag Prajapati on 08/09/2018 for saprate class for stories
public abstract class StoriesRecyclerOnScrollListener extends RecyclerView.OnScrollListener {
    public static String TAG = StoriesRecyclerOnScrollListener.class.getSimpleName();
    ...
    public StoriesRecyclerOnScrollListener(LayoutManager layoutManager, boolean isGrid) {
    ...
    public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
        ...
        /*if (loading) {///@chirag:07/09/2018 commented
        ...
        if (loading) {///@chirag:07/09/2018 added
            if (totalItemCount <= firstVisibleItem + 1 && totalItemCount >= visibleThreshold) {
