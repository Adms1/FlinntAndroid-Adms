...
import com.edu.flinnt.customviews.store.rangeseekbar.Utills;
import com.github.lzyzsd.circleprogress.Utils;

import static com.edu.flinnt.customviews.store.rangeseekbar.SeekBar.INDICATOR_MODE_ALWAYS_SHOW;
...
//    private float maxPositiveValue, minPositiveValue;
    ...
    private com.edu.flinnt.customviews.store.rangeseekbar.SeekBar leftSB;
    private com.edu.flinnt.customviews.store.rangeseekbar.SeekBar rightSB;
    private com.edu.flinnt.customviews.store.rangeseekbar.SeekBar currTouchSB;
    ...
    public RangeSeekBar(Context context, AttributeSet attrs) {
        ...
        leftSB = new com.edu.flinnt.customviews.store.rangeseekbar.SeekBar(this, attrs, true);
        rightSB = new com.edu.flinnt.customviews.store.rangeseekbar.SeekBar(this, attrs, false);
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        progressHeight = (int) t.getDimension(R.styleable.RangeSeekBar_rsb_progress_height, Utils.dp2px(getContext().getResources(),2));
        ...
        tickMarkTextMargin = (int) t.getDimension(R.styleable.RangeSeekBar_rsb_tick_mark_text_margin, Utils.dp2px(getContext().getResources(),7));
        tickMarkTextSize = (int) t.getDimension(R.styleable.RangeSeekBar_rsb_tick_mark_text_size, Utils.dp2px(getContext().getResources(),12));
        ...
        if (tickMarkTextArray != null) {
            ...
            for (int i = 0; i < tickMarkTextArray.length; i++) {
                ...
                if (tickMarkMode == TRICK_MARK_MODE_OTHER) {
                    ...
                    if (Utills.compareFloat(num, states[0].value) != -1 && Utills.compareFloat(num, states[1].value) != 1 && seekBarMode == SEEKBAR_MODE_RANGE) {
    ...
    public SeekBarState[] getRangeSeekBarState() {
        ...
        if (tickMarkNumber > 1){
            ...
            if (Utills.compareFloat(leftSB.currPercent, 0f) == 0){
                leftSeekBarState.isMin = true;
            }else if (Utills.compareFloat(leftSB.currPercent, 1f) == 0){
                leftSeekBarState.isMax = true;
            }
        }
        ...
        if (seekBarMode == SEEKBAR_MODE_RANGE) {
            ...
            if (tickMarkNumber > 1){
                ...
                if (Utills.compareFloat(rightSB.currPercent, 0f) == 0){
                    rightSeekBarState.isMin = true;
                }else if (Utills.compareFloat(rightSB.currPercent, 1f) == 0){
                    rightSeekBarState.isMax = true;
                }
            }
        }
     ...
     */
    public com.edu.flinnt.customviews.store.rangeseekbar.SeekBar getLeftSeekBar(){
        return leftSB;
    }

    public com.edu.flinnt.customviews.store.rangeseekbar.SeekBar getRightSeekBar(){
        return rightSB;
    }
